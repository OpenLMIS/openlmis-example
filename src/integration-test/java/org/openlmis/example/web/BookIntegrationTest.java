...
/*
  ...
  The RestAssured library makes it easy to make Restful calls and validate their responses. For each client-server
  interaction, an assertion is added to verify that the HTTP requests and responses match those defined
  within the "api-definition.yaml" RAML file.
*/
...
public class BookIntegrationTest
{
  ...
  public void testCreate() {
    ...
    //This is commented out because it complains about missing descriptions that aren't necessary at the moment
    ...
    //Create a user, making sure we get back a 201 along with the ISBN we expect in the response body
