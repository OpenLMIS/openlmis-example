...
{
    //Spring Data Rest doesn't automatically create an endpoint for this - see comments in NotificationController.java.
    long count();
    ...
    //Interestingly, without this entry, Spring Data Rest returns a 405 (Method Not Allowed) rather than a 404 (Not Found) response status.
    ...
    //Note that Spring Data Rest's hypermedia documents it as: http://127.0.0.1:8080/api/foos/search/findById{?id}"
