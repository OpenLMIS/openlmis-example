...
public class RestExceptionHandler
{
    ...
    public ResponseEntity<?> handleConstraintViolationException(TransactionSystemException exception, HttpServletRequest request)
    {
        if(exception.contains(javax.validation.ConstraintViolationException.class) || exception.contains(org.hibernate.exception.ConstraintViolationException.class)) {
    ...
    private static ExceptionDetail getExceptionDetail(Throwable throwable, HttpStatus status, String title)
    {
